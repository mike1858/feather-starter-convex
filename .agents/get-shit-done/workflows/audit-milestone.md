...
```bash
integration_checker_model=$(node "/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-integration-checker --raw)
```
...
node "/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/get-shit-done/bin/gsd-tools.cjs" phases list
```
...
PHASE_INFO=$(node "/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase 01 --raw)
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node "/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract "$summary" --fields requirements_completed --pick requirements_completed
done
```
...
```bash
NYQUIST_CONFIG=$(node "/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.nyquist_validation --raw 2>/dev/null)
```
