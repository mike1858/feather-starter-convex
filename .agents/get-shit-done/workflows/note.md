...
- **Global scope**: `/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/notes/`)
...
2. Glob `/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/siraj/Desktop/NonDropBoxProjects/feather-starter-convex/.claude/notes/` — works in any directory
