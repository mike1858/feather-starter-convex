...
import { List, LayoutGrid, Table2, Search, AlertCircle } from "lucide-react";
...
interface TestGenEmptyStateProps {
  variant?: EmptyStateVariant;
  onAction?: () => void;
}

export function TestGenEmptyState({
  variant = "noData",
  onAction,
}: TestGenEmptyStateProps) {
