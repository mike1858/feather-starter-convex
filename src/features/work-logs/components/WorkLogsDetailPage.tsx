...
interface WorkLogsDetailPageProps {
...
export function WorkLogsDetailPage({
  item,
  isLoading,
  onEdit,
  onSave,
  onDelete,
}: WorkLogsDetailPageProps) {
  ...
  const fields = [
    ...
    { key: "timeMinutes", label: "timeMinutes", type: "number" },
  ];
